...
export default function StudentViewModal({ isOpen, onClose, student }) {
  ...
  const formatDate = (date) =>
    date ? dayjs(date).format('MMMM DD, YYYY') : 'N/A';
    ...
    >
      <div className="py-4">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--foreground)] m-0">
              {student.name}
            </h2>
        ...
        <Divider orientation="left" className="border-[var(--border)]">
        ...
        >
          ...
          <Descriptions.Item label="Enroll No">
        ...
        <Divider orientation="left" className="border-[var(--border)] mt-6">
          <span className="text-[var(--muted-foreground)]">
